...
<div class="container">
        ...
        <form method=post action="booking">
         <input type="hidden"  name="sid" value="<% out.println(request.getParameter("sid")); %>">
         	<input type="hidden"  name="timingid" value="<%out.println(request.getParameter("time")); %>"> 
        <div class="first-row">
            <div class="owner">
                <h3>Owner</h3>
        ...
        <input type="submit" value="Confirm" id="a">

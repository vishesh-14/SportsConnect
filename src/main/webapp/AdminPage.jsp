...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            <li>
                <a href="https://www.youtube.com/results?search_query=to+show+the+avaiable+slot+website+ui" class="active">
                ...
                <div class="recent-sales box">
                    ...
                    <div class="sales-details">
                       <sql:query dataSource = "${db}" var = "result">
						    SELECT o.orderid, o.serviceid, o.oname, o.ouid, o.ouname, t.timeslot
						    from orders o join timing t 
						    on t.timingid = o.timingid order by o.orderid;
						</sql:query>	
                       <table border = "0px" style=" width: 1000px" >
						 ...
						 <c:forEach var = "row" items = "${result.rows}">
						    <tr>
						       <td class="displaycell" > <c:out value = "${row.orderid}"/></td>
						       <td class="displaycell"> <c:out value = "${row.serviceid}"/></td>
						       <td class="displaycell"> <c:out value = "${row.oname}"/></td>
						       <td class="displaycell"> <c:out value = "${row.ouid}"/></td>
						       <td class="displaycell"> <c:out value = "${row.ouname}"/></td>
